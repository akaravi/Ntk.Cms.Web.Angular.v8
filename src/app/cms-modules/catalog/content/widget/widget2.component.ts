...
import { CatalogContentService, EnumRecordStatus, FilterDataModel, FilterModel } from 'ntk-cms-api';
...
@Component({
  selector: 'app-catalog-content-widget2',
  templateUrl: './widget2.component.html',
  styleUrls: ['./widget2.component.scss']
})

export class CatalogContentWidget2Component implements OnInit, OnDestroy {
  @Input() cssClass = '';
