...
import {
  ...
  CatalogContentModel,
  CatalogContentService, DataFieldInfoModel,
...
export class CatalogContentListComponent implements OnInit, OnDestroy {
  ...
  DataGetAll(): void {
    ...
    this.tableRowSelected = new CatalogContentModel();
  ...
  onActionbuttonDeleteRow(model: CatalogContentModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(CatalogContentDeleteComponent, { height: '90%', data: { id: this.tableRowSelected.id } });
