...
import {
  ...
  CatalogCategoryService, CoreEnumService, EnumClauseType, EnumFilterDataModelSearchTypes, ErrorExceptionResult,
  FilterDataModel,
  FilterModel
} from 'ntk-cms-api';
...
export class CatalogCategorySelectorComponent implements OnInit {
  ...
  filteredOptions: Observable<CatalogCategoryModel[]>;
  ...
  displayFn(model?: CatalogCategoryModel): string | undefined {
    return model ? model.title : undefined;
  }
  displayOption(model?: CatalogCategoryModel): string | undefined {
    return model ? model.title : undefined;
  }
  async DataGetAll(text: string | number | any): Promise<CatalogCategoryModel[]> {
  ...
  push(newvalue: CatalogCategoryModel): Observable<CatalogCategoryModel[]> {
  ...
  onActionSelectForce(id: number | CatalogCategoryModel): void {
    ...
    if (typeof id === typeof CatalogCategoryModel) {
      this.filteredOptions = this.push((id as CatalogCategoryModel));
      this.dataModelSelect = (id as CatalogCategoryModel);
