...
import {
  CatalogCategoryModel, CatalogCategoryService, CoreEnumService, DataFieldInfoModel, EnumInfoModel,
...
export class CatalogCategoryAddComponent implements OnInit {
  requestParentId = '';
  constructor(
