...
import {
  AccessModel, CatalogConfigurationService,
  CatalogModuleConfigSiteAccessValuesModel,
  CatalogModuleConfigSiteValuesModel,
  CatalogModuleSiteStorageValuesModel, CoreEnumService,
...
export class CatalogConfigSiteComponent implements OnInit {
  requestLinkSiteId = 0;
  constructor(
  ...
  dataSiteStorageModel = new CatalogModuleSiteStorageValuesModel();
  dataConfigSiteValuesModel = new CatalogModuleConfigSiteValuesModel();
  dataConfigSiteAccessValuesModel = new CatalogModuleConfigSiteAccessValuesModel();
