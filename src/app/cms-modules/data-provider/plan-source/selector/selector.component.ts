...
import {
  ...
  DataProviderPlanSourceService, EnumClauseType,
...
@Component({
  selector: 'app-data-provider-plan-source-selector',
  templateUrl: './selector.component.html',
})
export class DataProviderPlanSourceSelectorComponent implements OnInit {
  constructor(
  ...
  filteredOptions: Observable<DataProviderPlanSourceModel[]>;
  ...
  async DataGetAll(text: string | number | any): Promise<DataProviderPlanSourceModel[]> {
  ...
  push(newvalue: DataProviderPlanSourceModel): Observable<DataProviderPlanSourceModel[]> {
  ...
  onActionSelectForce(id: number | DataProviderPlanSourceModel): void {
    ...
    if (typeof id === typeof DataProviderPlanSourceModel) {
      this.filteredOptions = this.push((id as DataProviderPlanSourceModel));
      this.dataModelSelect = (id as DataProviderPlanSourceModel);
