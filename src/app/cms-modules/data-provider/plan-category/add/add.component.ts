...
import {
  CoreEnumService, DataFieldInfoModel, DataProviderPlanCategoryModel,
  DataProviderPlanCategoryService, EnumInfoModel,
...
export class DataProviderPlanCategoryAddComponent implements OnInit {
  requestParentId = 0;
  constructor(
  ...
  dataModel: DataProviderPlanCategoryModel = new DataProviderPlanCategoryModel();
