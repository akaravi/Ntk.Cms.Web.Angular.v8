...
import {
  ...
  DataProviderPlanPriceService, ErrorExceptionResult, InfoEnumModel, RecordStatusEnum
} from 'ntk-cms-api';
...
export class DataProviderPlanPriceHeaderComponent implements OnInit, OnDestroy {
  ...
  onActionbuttonLinkTo(model: DataProviderPlanPriceModel = this.dataModelResult.item): void {
