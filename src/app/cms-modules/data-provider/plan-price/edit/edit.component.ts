...
export class DataProviderPlanPriceEditComponent implements OnInit {
  requestId = 0;
  constructor(
  ...
  DataGetOneContent(): void {
    ...
    this.dataproviderplanpriceservice.setAccessDataType(ManageUserAccessDataTypesEnum.Editor);
