...
import {
  DataFieldInfoModel, DataProviderLogClientModel,
  DataProviderLogClientService, EnumRecordStatus, EnumSortType,
...
export class DataProviderLogClientListComponent implements OnInit, OnDestroy {
  ...
  DataGetAll(): void {
    ...
    this.tableRowSelected = new DataProviderLogClientModel();
