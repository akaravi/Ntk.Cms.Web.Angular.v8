...
import {
  ...
  ApiTelegramReceivedFileService, DataFieldInfoModel, EnumRecordStatus, EnumSortType,
...
export class ApiTelegramReceivedFileListComponent implements OnInit, OnDestroy {
  ...
  expandedElement: ApiTelegramReceivedFileModel | null;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new ApiTelegramReceivedFileModel());
