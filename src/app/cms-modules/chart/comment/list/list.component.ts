...
import {
  ChartCommentModel,
  ChartCommentService, ChartContentService, DataFieldInfoModel, EnumFilterDataModelSearchTypes, EnumRecordStatus,
  EnumSortType,
...
export class ChartCommentListComponent implements OnInit, OnDestroy {
  ...
  onActionbuttonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(ChartCommentEditComponent, {
      height: '90%',
