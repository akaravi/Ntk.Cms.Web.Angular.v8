...
import {
  ...
  FormInfoModel, InfoEnumModel, LinkManagementAccountingModel, LinkManagementAccountingService, LinkManagementMemberModel, ManageUserAccessDataTypesEnum
} from 'ntk-cms-api';
...
@Component({
  selector: 'app-linkmanagement-accounting-edit',
  templateUrl: './edit.component.html',
  styleUrls: ['./edit.component.scss'],
})
export class LinkManagementAccountingEditComponent implements OnInit {
  requestId = 0;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<LinkManagementAccountingEditComponent>,
