...
import {
  ...
  FormInfoModel, InfoEnumModel, LinkManagementCategoryModel, LinkManagementCategoryService, ManageUserAccessDataTypesEnum
} from 'ntk-cms-api';
...
@Component({
  selector: 'app-linkmanagement-category-edit',
  templateUrl: './edit.component.html',
  styleUrls: ['./edit.component.scss'],
})
export class LinkManagementCategoryEditComponent implements OnInit {
  requestId = 0;
  constructor(
