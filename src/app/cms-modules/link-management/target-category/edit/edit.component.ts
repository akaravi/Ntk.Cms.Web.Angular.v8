...
import {
  ...
  FormInfoModel, InfoEnumModel, LinkManagementTargetCategoryModel, LinkManagementTargetCategoryService, ManageUserAccessDataTypesEnum
} from 'ntk-cms-api';
...
@Component({
  selector: 'app-linkmanagement-target-category-edit',
  templateUrl: './edit.component.html',
  styleUrls: ['./edit.component.scss'],
})
export class LinkManagementTargetCategoryEditComponent implements OnInit {
  requestId = 0;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<LinkManagementTargetCategoryEditComponent>,
