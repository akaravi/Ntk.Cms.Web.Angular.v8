...
import {
  ...
  FilterDataModel,
  FilterModel,
  TokenInfoModel, WebDesignerLogMemberInfoModel,
...
export class WebDesignerLogMemberInfoListComponent implements OnInit, OnDestroy {
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new WebDesignerLogMemberInfoModel());
  ...
  onActionbuttonViewRow(model: WebDesignerLogMemberInfoModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(WebDesignerLogMemberInfoViewComponent, {
      height: '90%',
