...
import {
  CoreCurrencyModel, CoreCurrencyService, CoreEnumService, DataFieldInfoModel, ErrorExceptionResult,
...
export class CoreCurrencyEditComponent implements OnInit {
  ...
  DataGetOneContent(): void {
    ...
    this.coreCurrencyService.setAccessDataType(ManageUserAccessDataTypesEnum.Editor);
