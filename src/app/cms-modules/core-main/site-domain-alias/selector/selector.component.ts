...
import {
  CoreEnumService, CoreSiteDomainAliasModel,
  CoreSiteDomainAliasService, EnumClauseType, EnumFilterDataModelSearchTypes, ErrorExceptionResult,
  FilterDataModel,
  FilterModel
} from 'ntk-cms-api';
...
export class CoreSiteDomainAliasSelectorComponent implements OnInit {
  ...
  @Output() optionChange = new EventEmitter<CoreSiteDomainAliasModel>();
