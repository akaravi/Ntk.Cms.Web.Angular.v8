...
@Component({
  selector: 'app-core-modulesaleheader-edit',
  templateUrl: './edit.component.html',
  styleUrls: ['./edit.component.scss'],
})
export class CoreModuleSaleHeaderEditComponent implements OnInit {
  requestId = 0;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<CoreModuleSaleHeaderEditComponent>,
  ...
  DataGetOneContent(): void {
    ...
    this.coreModuleSaleHeaderService.setAccessDataType(ManageUserAccessDataTypesEnum.Editor);
