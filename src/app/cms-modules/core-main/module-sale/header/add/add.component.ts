...
import {
  CoreEnumService, CoreModuleSaleHeaderGroupModel, CoreModuleSaleHeaderModel, CoreModuleSaleHeaderService, DataFieldInfoModel, EnumInfoModel,
...
export class CoreModuleSaleHeaderAddComponent implements OnInit {
  requestParentId = 0;
  constructor(
