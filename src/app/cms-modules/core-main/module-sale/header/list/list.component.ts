...
import {
  CoreModuleSaleHeaderGroupModel, CoreModuleSaleHeaderModel,
  CoreModuleSaleHeaderService, DataFieldInfoModel, EnumRecordStatus, EnumSortType,
...
export class CoreModuleSaleHeaderListComponent implements OnInit, OnDestroy {
  ...
  constructor(
    public contentService: CoreModuleSaleHeaderService,
  ...
  onActionbuttonEditRow(model: CoreModuleSaleHeaderModel = this.tableRowSelected): void {
  ...
  onActionSelectorSelect(model: CoreModuleSaleHeaderGroupModel | null): void {
    /*filter */
  ...
  onActionbuttonDeleteRow(model: CoreModuleSaleHeaderModel = this.tableRowSelected): void {
    if (!model || !model.id || model.id === 0) {
  ...
  onActionbuttonModuleList(model: CoreModuleSaleHeaderModel = this.tableRowSelected): void {
    ...
    this.router.navigate(['/core/sitecategorymodule/LinkCmsModuleSaleHeaderId', this.tableRowSelected.id]);
  ...
  onActionbuttonSiteList(model: CoreModuleSaleHeaderModel = this.tableRowSelected): void {
    ...
    this.router.navigate(['/core/site/list/LinkModuleSaleHeaderId', this.tableRowSelected.id]);
