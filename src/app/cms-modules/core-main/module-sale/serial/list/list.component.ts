...
import {
  ...
  CoreModuleSaleSerialService, DataFieldInfoModel, EnumRecordStatus, EnumSortType,
...
export class CoreModuleSaleSerialListComponent implements OnInit, OnDestroy {
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new CoreModuleSaleSerialModel());
    ...
    if (this.categoryModelSelected && this.categoryModelSelected.id > 0) {
      ...
      fastfilter.propertyName = 'LinkModuleSaleHeaderId';
  ...
  onActionTableRowSelect(row: CoreModuleSaleSerialModel): void {
