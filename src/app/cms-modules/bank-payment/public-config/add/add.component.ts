...
import {
  BankPaymentPublicConfigModel, BankPaymentPublicConfigService, CoreCurrencyModel, CoreEnumService, DataFieldInfoModel, EnumInfoModel,
...
export class BankPaymentPublicConfigAddComponent implements OnInit {
  ...
  DataGetAccess(): void {
    ...
    this.bankPaymentPublicConfigService
      .ServiceViewModel()
      .subscribe({
        next: (ret) => {
          if (ret.isSuccess) {
