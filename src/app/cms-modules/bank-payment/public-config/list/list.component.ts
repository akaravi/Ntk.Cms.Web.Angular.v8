...
import {
  ...
  BankPaymentPublicConfigService, CoreCurrencyModel, CoreCurrencyService, DataFieldInfoModel, EnumRecordStatus, EnumSortType,
...
export class BankPaymentPublicConfigListComponent implements OnInit, OnDestroy {
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new BankPaymentPublicConfigModel());
