...
export class DonateTargetPeriodSponserEditComponent implements OnInit {
  requestId = 0;
  constructor(
  ...
  DataGetOneContent(): void {
    ...
    this.donateTargetPeriodSponsorService.setAccessDataType(ManageUserAccessDataTypesEnum.Editor);
