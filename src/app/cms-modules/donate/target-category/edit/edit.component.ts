...
import {
  CoreEnumService, DataFieldInfoModel, DonateTargetCategoryModel, DonateTargetCategoryService, ErrorExceptionResult,
...
@Component({
  selector: 'app-donate-target-category-edit',
  templateUrl: './edit.component.html',
  styleUrls: ['./edit.component.scss'],
})
export class DonateTargetCategoryEditComponent implements OnInit {
  requestId = 0;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<DonateTargetCategoryEditComponent>,
  ...
  DataGetOneContent(): void {
    ...
    this.donateTargetCategoryService.ServiceGetOneById(this.requestId).subscribe({
      next: (ret) => {
