...
import {
  CoreEnumService, DonateTargetCategoryModel,
  DonateTargetCategoryService, EnumClauseType,
...
export class DonateTargetCategorySelectorComponent implements OnInit {
  ...
  displayFn(model?: DonateTargetCategoryModel): string | undefined {
    return model ? model.title : undefined;
  }
  displayOption(model?: DonateTargetCategoryModel): string | undefined {
    return model ? model.title : undefined;
  }
  async DataGetAll(text: string | number | any): Promise<DonateTargetCategoryModel[]> {
  ...
  push(newvalue: DonateTargetCategoryModel): Observable<DonateTargetCategoryModel[]> {
  ...
  onActionSelectForce(id: number | DonateTargetCategoryModel): void {
    ...
    if (typeof id === typeof DonateTargetCategoryModel) {
      this.filteredOptions = this.push((id as DonateTargetCategoryModel));
      this.dataModelSelect = (id as DonateTargetCategoryModel);
