...
import {
  CoreEnumService, CoreModuleSiteCreditModel, CoreModuleSiteCreditService, DataFieldInfoModel, ErrorExceptionResult,
...
export class CoreModuleSiteCreditEditComponent implements OnInit {
  requestId = 0;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<CoreModuleSiteCreditEditComponent>,
