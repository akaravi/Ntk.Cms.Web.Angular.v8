...
import {
  CoreEnumService, CoreModuleDataTaskModel, CoreModuleDataTaskService, CoreSiteModel, DataFieldInfoModel, ErrorExceptionResult, FilterDataModel, FilterModel, RecordStatusEnum, SortTypeEnum, TokenInfoModel
} from 'ntk-cms-api';
...
import { CoreModuleDataTaskEditComponent } from '../edit/edit.component';
...
export class CoreModuleDataTaskListComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  constructor(
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new CoreModuleDataTaskModel());
  ...
  //     return;
  //   }
  //   const dialogRef = this.dialog.open(CoreModuleDataTaskAddComponent, {
  //     height: '90%',
  //     data: {
  ...
  onActionbuttonViewRow(model: CoreModuleDataTaskModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(CoreModuleDataTaskViewComponent, {
      height: '90%',
  ...
  onActionbuttonEditRow(model: CoreModuleDataTaskModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(CoreModuleDataTaskEditComponent, {
      height: '90%',
      data: { id: this.tableRowSelected.id }
    });
    dialogRef.afterClosed().subscribe(result => {
  ...
  onActionTableRowSelect(row: CoreModuleDataTaskModel): void {
