...
import {
  CoreEnumService, CoreModuleDataTaskModel, CoreModuleDataTaskService, DataFieldInfoModel, ErrorExceptionResult,
...
export class CoreModuleDataTaskEditComponent implements OnInit, OnDestroy {
  requestId = '';
  constructor(
