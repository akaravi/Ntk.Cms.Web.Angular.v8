...
export class CoreModuleDataPinListComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  constructor(
    private coreEnumService: CoreEnumService,
    public contentService: CoreModuleDataPinService,
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new CoreModuleDataPinModel());
  ...
  //     return;
  //   }
  //   const dialogRef = this.dialog.open(CoreModuleDataPinAddComponent, {
  //     height: '90%',
  //     data: {
  ...
  onActionbuttonViewRow(model: CoreModuleDataPinModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(CoreModuleDataPinViewComponent, {
      height: '90%',
  ...
  onActionbuttonEditRow(model: CoreModuleDataPinModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(CoreModuleDataPinEditComponent, {
      height: '90%',
      data: { id: this.tableRowSelected.id }
    });
    dialogRef.afterClosed().subscribe(result => {
