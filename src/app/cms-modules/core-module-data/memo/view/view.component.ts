...
import {
  CoreEnumService, CoreModuleDataMemoModel, CoreModuleDataMemoService, DataFieldInfoModel, EnumInfoModel,
...
export class CoreModuleDataMemoViewComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<CoreModuleDataMemoViewComponent>,
