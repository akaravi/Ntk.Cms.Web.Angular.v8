...
import {
  ...
  FilterDataModel,
  FilterModel, RecordStatusEnum, SortTypeEnum, TicketingDepartemenModel, TicketingTemplateModel,
  TicketingTemplateService, TokenInfoModel
} from 'ntk-cms-api';
...
export class TicketingTemplateListComponent implements OnInit, OnDestroy {
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new TicketingTemplateModel());
