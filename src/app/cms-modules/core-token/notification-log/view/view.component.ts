...
import {
  CoreEnumService, CoreTokenNotificationLogModel, CoreTokenNotificationLogService, DataFieldInfoModel, EnumInfoModel,
...
@Component({
  selector: 'app-core-token-notificationlog-view',
