...
import {
  CoreSiteModel, CoreTokenMicroServiceModel, CoreTokenMicroServiceService, DataFieldInfoModel,
...
export class CoreTokenMicroServiceListComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  requestLinkUserId = 0;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new CoreTokenMicroServiceModel());
