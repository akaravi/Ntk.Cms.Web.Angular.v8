...
import {
  CoreSiteModel, CoreTokenMicroServiceLogModel, CoreTokenMicroServiceLogService, DataFieldInfoModel,
...
export class CoreTokenMicroServiceLogListComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  requestLinkUserId = 0;
  ...
  onActionTableRowSelect(row: CoreTokenMicroServiceLogModel): void {
