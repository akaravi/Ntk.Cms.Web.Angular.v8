...
import { EstateCustomerOrderAddComponent } from '../add/add.component';
import { EstateCustomerOrderEditComponent } from '../edit/edit.component';
@Component({
  selector: 'app-estate-customer-order-tree',
  templateUrl: './tree.component.html',
  styleUrls: ['./tree.component.scss'],
})
export class EstateCustomerOrderTreeComponent implements OnInit, OnDestroy {
  constructor(
  ...
  @Input() set optionSelectForce(x: number | EstateCustomerOrderModel) {
  ...
  hasChild = (_: number, node: EstateCustomerOrderModel) => false;
  ...
  onActionSelectForce(id: number | EstateCustomerOrderModel): void {
  ...
  onActionAdd(): void {
    ...
    const dialogRef = this.dialog.open(EstateCustomerOrderAddComponent, {
      height: '90%',
  ...
  onActionEdit(): void {
    ...
    if (this.tokenHelper.isMobile)
      ...
      panelClass = 'dialog-min';
    const dialogRef = this.dialog.open(EstateCustomerOrderEditComponent, {
      height: '90%',
      panelClass: panelClass,
      data: { id }
    });
