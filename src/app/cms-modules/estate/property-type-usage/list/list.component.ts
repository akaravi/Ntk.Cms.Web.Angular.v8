...
import {
  DataFieldInfoModel, ErrorExceptionResult, EstatePropertyTypeUsageModel,
  EstatePropertyTypeUsageService, FilterDataModel, FilterModel, RecordStatusEnum, SortTypeEnum, TokenInfoModel
} from 'ntk-cms-api';
...
export class EstatePropertyTypeUsageListComponent implements OnInit, OnDestroy {
  constructor(
  ...
  expandedElement: EstatePropertyTypeUsageModel | null;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new EstatePropertyTypeUsageModel());
