...
import {
  CoreEnumService, DataFieldInfoModel, EnumInfoModel, EnumManageUserAccessDataTypes, ErrorExceptionResult, EstatePropertyTypeLanduseModel, EstatePropertyTypeModel, EstatePropertyTypeService, EstatePropertyTypeUsageModel, EstatePropertyTypeUsageService, FilterDataModel, FilterModel, FormInfoModel, TokenInfoModel
} from 'ntk-cms-api';
...
export class EstatePropertyTypeUsageEditComponent implements OnInit {
  ...
  DataGetOneContent(): void {
    ...
    this.estatePropertyTypeUsageService.setAccessDataType(EnumManageUserAccessDataTypes.Editor);
