...
import {
  DataFieldInfoModel, ErrorExceptionResult, EstateAccountAgencyWorkAreaModel,
  EstateAccountAgencyWorkAreaService, FilterDataModel, FilterModel, RecordStatusEnum, SortTypeEnum, TokenInfoModel
} from 'ntk-cms-api';
...
export class EstateAccountAgencyWorkAreaListComponent implements OnInit, OnDestroy {
  constructor(
  ...
  expandedElement: EstateAccountAgencyWorkAreaModel | null;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new EstateAccountAgencyWorkAreaModel());
  ...
  onActionTableRowSelect(row: EstateAccountAgencyWorkAreaModel): void {
