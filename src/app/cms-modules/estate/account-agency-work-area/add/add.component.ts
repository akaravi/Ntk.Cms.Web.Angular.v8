...
import {
  ...
  ErrorExceptionResult, EstateAccountAgencyModel, EstateAccountAgencyWorkAreaModel, EstateAccountAgencyWorkAreaService, EstateAccountUserModel, EstateEnumService, FormInfoModel, TokenInfoModel
} from 'ntk-cms-api';
...
export class EstateAccountAgencyWorkAreaAddComponent implements OnInit {
  constructor(
  ...
  DataGetAccess(): void {
    ...
    this.estateAccountAgencyWorkAreaService
      .ServiceViewModel()
      .subscribe({
        next: (ret) => {
          if (ret.isSuccess) {
