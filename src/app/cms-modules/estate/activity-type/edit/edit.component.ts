...
import {
  CoreEnumService, DataFieldInfoModel, ErrorExceptionResult, EstateActivityTypeModel, EstateActivityTypeService, EstatePropertyTypeModel, EstatePropertyTypeService, EstatePropertyTypeUsageModel, FilterDataModel, FilterModel, FormInfoModel, InfoEnumModel, ManageUserAccessDataTypesEnum
} from 'ntk-cms-api';
...
@Component({
  selector: 'app-estate-activity-type-edit',
  templateUrl: './edit.component.html',
  styleUrls: ['./edit.component.scss'],
})
export class EstateActivityTypeEditComponent implements OnInit {
  requestId = '';
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<EstateActivityTypeEditComponent>,
  ...
  DataGetOneContent(): void {
    ...
    this.estateActivityTypeService.setAccessLoad();
    this.estateActivityTypeService.setAccessDataType(ManageUserAccessDataTypesEnum.Editor);
    this.estateActivityTypeService.ServiceGetOneById(this.requestId).subscribe({
      next: (ret) => {
  ...
  DataEditContent(): void {
    ...
    this.estateActivityTypeService.ServiceEdit(this.dataModel).subscribe({
      next: (ret) => {
