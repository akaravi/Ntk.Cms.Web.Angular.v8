...
import {
  DataFieldInfoModel, ErrorExceptionResult, EstateActivityTypeModel,
  EstateActivityTypeService, FilterDataModel, FilterModel, RecordStatusEnum, SortTypeEnum, TokenInfoModel
} from 'ntk-cms-api';
...
export class EstateActivityTypeListComponent implements OnInit, OnDestroy {
  ...
  expandedElement: EstateActivityTypeModel | null;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new EstateActivityTypeModel());
  ...
  onActionbuttonContentDetailList(model: EstateActivityTypeModel = this.tableRowSelected, event?: MouseEvent): void {
    ...
    if (event?.ctrlKey) {
      this.link = "/#/estate/property-detail/LinkActivityTypeId/" + this.tableRowSelected.id;
  ...
  onActionbuttonContentList(model: EstateActivityTypeModel = this.tableRowSelected, event?: MouseEvent): void {
    ...
    if (event?.ctrlKey) {
      this.link = "/#/estate/property/LinkActivityTypeId/" + this.tableRowSelected.id;
      window.open(this.link, "_blank");
    } else {
