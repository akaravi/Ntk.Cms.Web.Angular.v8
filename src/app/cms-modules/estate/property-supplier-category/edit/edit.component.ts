...
@Component({
  selector: 'app-estate-property-supplier-category-edit',
  templateUrl: './edit.component.html',
  styleUrls: ['./edit.component.scss'],
})
export class EstatePropertySupplierCategoryEditComponent implements OnInit {
  requestId = '';
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<EstatePropertySupplierCategoryEditComponent>,
  ...
  DataGetAllEstatePropertyUsage(): void {
    ...
    filter.propertyName = 'LinkPropertySupplierCategoryId';
