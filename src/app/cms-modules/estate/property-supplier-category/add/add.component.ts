...
import {
  CoreEnumService, DataFieldInfoModel, ErrorExceptionResult, EstatePropertySupplierCategoryModel, EstatePropertySupplierCategoryService, FormInfoModel, InfoEnumModel
} from 'ntk-cms-api';
...
@Component({
  selector: 'app-estate-property-supplier-category-add',
  templateUrl: './add.component.html',
  styleUrls: ['./add.component.scss'],
})
export class EstatePropertySupplierCategoryAddComponent implements OnInit {
  constructor(
  ...
  DataAddContent(): void {
    ...
    this.estatePropertySupplierCategoryService.ServiceAdd(this.dataModel).subscribe({
      next: (ret) => {
