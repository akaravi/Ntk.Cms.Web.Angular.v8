...
import {
  ...
  ErrorExceptionResult, EstateAccountUserWorkAreaModel,
  EstateAccountUserWorkAreaService, FilterDataModel, FilterModel,
  TokenInfoModel
} from 'ntk-cms-api';
...
export class EstateAccountUserWorkAreaListComponent implements OnInit, OnDestroy {
  constructor(
    private contentService: EstateAccountUserWorkAreaService,
  ...
  expandedElement: EstateAccountUserWorkAreaModel | null;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new EstateAccountUserWorkAreaModel());
  ...
  onActionbuttonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(EstateAccountUserWorkAreaAddComponent, {
      height: '90%',
      data: {}
    });
