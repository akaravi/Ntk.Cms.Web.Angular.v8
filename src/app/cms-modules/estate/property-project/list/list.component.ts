...
export class EstatePropertyProjectListComponent implements OnInit, OnDestroy {
  constructor(
  ...
  DataGetAll(): void {
    ...
    this.tableRowSelected = new EstatePropertyProjectModel();
  ...
  onActionTableRowSelect(row: EstatePropertyProjectModel): void {
  ...
  onActionTableRowMouseEnter(row: EstatePropertyProjectModel): void {
    this.tableRowSelected = row;
    row["expanded"] = true;
  }
  onActionTableRowMouseLeave(row: EstatePropertyProjectModel): void {
    row["expanded"] = false;
  }
  expandedElement: any;
