...
import {
  ...
  EstateAccountAgencyAdsService, FilterDataModel, FilterModel,
  TokenInfoModel
} from 'ntk-cms-api';
...
export class EstateAccountAgencyAdsListComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    if (this.requestLinkAccountAgencyId && this.requestLinkAccountAgencyId.length > 0) {
      ...
      filter.propertyName = 'LinkAccountAgencyId';
  ...
  expandedElement: EstateAccountAgencyAdsModel | null;
  ...
  onActionbuttonEditRow(model: EstateAccountAgencyAdsModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(EstateAccountAgencyAdsEditComponent, {
      height: '90%',
