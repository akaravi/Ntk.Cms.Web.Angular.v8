...
export class EstatePropertyCompanyEditComponent implements OnInit, AfterViewInit {
  requestId = '';
  constructor(
  ...
  contentSimilarSelected: EstatePropertyCompanyModel = new EstatePropertyCompanyModel();
  ...
  onActionContentSimilarSelect(model: EstatePropertyCompanyModel | null): void {
