...
export class EstatePropertyCompanyListComponent implements OnInit, OnDestroy {
  ...
  DataGetAll(): void {
    ...
    this.tableRowSelected = new EstatePropertyCompanyModel();
  ...
  onActionbuttonDeleteRow(model: EstatePropertyCompanyModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(EstatePropertyCompanyDeleteComponent, { data: { id: this.tableRowSelected.id } });
