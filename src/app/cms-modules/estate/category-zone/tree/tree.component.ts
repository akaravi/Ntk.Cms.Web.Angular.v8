...
import {
  CoreEnumService,
  ErrorExceptionResult, EstateCategoryZoneModel,
  EstateCategoryZoneService, FilterModel
} from 'ntk-cms-api';
...
@Component({
  selector: 'app-estate-category-zone-tree',
  templateUrl: './tree.component.html',
  styleUrls: ['./tree.component.scss'],
})
export class EstateCategoryZoneTreeComponent implements OnInit, OnDestroy {
  constructor(
    private cmsToastrService: CmsToastrService,
    public coreEnumService: CoreEnumService,
    public categoryService: EstateCategoryZoneService,
  ...
  treeControl = new NestedTreeControl<EstateCategoryZoneModel>(node => null);
  dataSource = new MatTreeNestedDataSource<EstateCategoryZoneModel>();
  @Output() optionChange = new EventEmitter<EstateCategoryZoneModel>();
  cmsApiStoreSubscribe: Subscription;
  @Input() optionReload = () => this.onActionReload();

  hasChild = (_: number, node: EstateCategoryZoneModel) => false;
  ...
  onActionReload(): void {
    ...
    this.dataModelSelect = new EstateCategoryZoneModel();
    this.DataGetAll();
  }
  onActionSelectForce(id: number | EstateCategoryZoneModel): void {
