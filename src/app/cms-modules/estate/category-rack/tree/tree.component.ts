...
import {
  ...
  EstateCategoryRackService, FilterModel
} from 'ntk-cms-api';
...
export class EstateCategoryRackTreeComponent implements OnInit, OnDestroy {
  ...
  treeControl = new NestedTreeControl<EstateCategoryRackModel>(node => null);
  dataSource = new MatTreeNestedDataSource<EstateCategoryRackModel>();
  ...
  onActionSelectForce(id: number | EstateCategoryRackModel): void {
