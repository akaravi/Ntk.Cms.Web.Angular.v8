...
import {
  ...
  ErrorExceptionResult, FilterDataModel, FilterModel, SmsMainCustomerCreditModel,
  SmsMainCustomerCreditService, TokenInfoModel
} from 'ntk-cms-api';
...
export class SmsMainCustomerCreditListComponent implements OnInit, OnDestroy {
  ...
  expandedElement: SmsMainCustomerCreditModel | null;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new SmsMainCustomerCreditModel());
