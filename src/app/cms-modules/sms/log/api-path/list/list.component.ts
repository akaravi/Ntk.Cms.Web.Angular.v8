...
import {
  CoreCurrencyModel, DataFieldInfoModel, ErrorExceptionResult, FilterDataModel, FilterModel, RecordStatusEnum, SmsLogApiPathModel,
  SmsLogApiPathService, SmsMainApiPathModel, SmsMainApiPathService, SortTypeEnum, TokenInfoModel
} from 'ntk-cms-api';
...
export class SmsLogApiPathListComponent implements OnInit, OnDestroy {
  ...
  dataModelResult: ErrorExceptionResult<SmsLogApiPathModel> = new ErrorExceptionResult<SmsLogApiPathModel>();
  ...
  onActionbuttonDeleteRow(model: SmsLogApiPathModel = this.tableRowSelected): void {
