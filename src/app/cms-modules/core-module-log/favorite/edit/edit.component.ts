...
export class CoreModuleLogFavoriteEditComponent implements OnInit, OnDestroy {
  requestId = '';
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<CoreModuleLogFavoriteEditComponent>,
  ...
  DataGetOneContent(): void {
    ...
    this.coreModuleLogFavoriteService.setAccessDataType(ManageUserAccessDataTypesEnum.Editor);
  ...
  DataEditContent(): void {
    ...
    this.coreModuleLogFavoriteService.ServiceEdit(this.dataModel).subscribe({
      next: (ret) => {
