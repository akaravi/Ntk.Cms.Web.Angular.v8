...
import {
  CoreEnumService, CoreModuleLogScoreModel, CoreModuleLogScoreService, CoreSiteModel, DataFieldInfoModel, RecordStatusEnum, SortTypeEnum,
...
export class CoreModuleLogScoreListComponent implements OnInit, OnDestroy {
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new CoreModuleLogScoreModel());
