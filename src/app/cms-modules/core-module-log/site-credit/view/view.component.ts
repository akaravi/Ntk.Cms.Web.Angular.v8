...
import {
  CoreEnumService, CoreModuleLogSiteCreditModel, CoreModuleLogSiteCreditService, DataFieldInfoModel, EnumInfoModel,
...
@Component({
  selector: 'app-coremodulelog-site-credit--view',
  templateUrl: './view.component.html',
})
export class CoreModuleLogSiteCreditViewComponent implements OnInit, OnDestroy {
  requestId = '';
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<CoreModuleLogSiteCreditViewComponent>,
