...
import { CoreModuleLogSiteCreditBlockedEditComponent } from '../edit/edit.component';
import { CoreModuleLogSiteCreditBlockedViewComponent } from '../view/view.component';
...
export class CoreModuleLogSiteCreditBlockedListComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  requestLinkUserId = 0;
  ...
  tableRowsSelected: Array<CoreModuleLogSiteCreditBlockedModel> = [];
  tableRowSelected: CoreModuleLogSiteCreditBlockedModel = new CoreModuleLogSiteCreditBlockedModel();
  tableSource: MatTableDataSource<CoreModuleLogSiteCreditBlockedModel> = new MatTableDataSource<CoreModuleLogSiteCreditBlockedModel>();
  ...
  onActionbuttonViewRow(model: CoreModuleLogSiteCreditBlockedModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(CoreModuleLogSiteCreditBlockedViewComponent, {
      height: '90%',
  ...
  onActionbuttonEditRow(model: CoreModuleLogSiteCreditBlockedModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(CoreModuleLogSiteCreditBlockedEditComponent, {
      height: '90%',
      data: { id: this.tableRowSelected.id }
    });
    dialogRef.afterClosed().subscribe(result => {
  ...
  onActionbuttonDeleteRow(model: CoreModuleLogSiteCreditBlockedModel = this.tableRowSelected): void {
    if (!model || !model.id || model.id.length === 0) {
  ...
  onActionbuttonViewSiteRow(model: CoreModuleLogSiteCreditBlockedModel = this.tableRowSelected): void {
