...
import {
  CoreEnumService, CoreModuleLogLikeModel, CoreModuleLogLikeService, CoreSiteModel, DataFieldInfoModel, EnumRecordStatus, EnumSortType,
...
export class CoreModuleLogLikeListComponent implements OnInit, OnDestroy {
  ...
  DataGetAll(): void {
    ...
    this.tableRowSelected = new CoreModuleLogLikeModel();
