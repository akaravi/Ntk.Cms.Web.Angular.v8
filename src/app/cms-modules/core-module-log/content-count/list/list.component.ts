...
import {
  CoreEnumService, CoreModuleLogContentCountModel, CoreModuleLogContentCountService, CoreSiteModel, DataFieldInfoModel, EnumRecordStatus, EnumSortType,
...
export class CoreModuleLogContentCountListComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  requestLinkUserId = 0;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new CoreModuleLogContentCountModel());
  ...
  onActionbuttonViewRow(model: CoreModuleLogContentCountModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(CoreModuleLogContentCountViewComponent, {
      height: '90%',
  ...
  onActionbuttonEditRow(model: CoreModuleLogContentCountModel = this.tableRowSelected): void {
    ...
    const dialogRef = this.dialog.open(CoreModuleLogContentCountEditComponent, {
      height: '90%',
      data: { id: this.tableRowSelected.id }
    });
    dialogRef.afterClosed().subscribe(result => {
  ...
  onActionTableRowSelect(row: CoreModuleLogContentCountModel): void {
