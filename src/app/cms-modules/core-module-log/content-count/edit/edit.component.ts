...
@Component({
  selector: 'app-coremodulelog-content-count-edit',
...
export class CoreModuleLogContentCountEditComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<CoreModuleLogContentCountEditComponent>,
    public coreEnumService: CoreEnumService,
    public coreModuleLogContentCountService: CoreModuleLogContentCountService,
  ...
  dataModel: CoreModuleLogContentCountModel = new CoreModuleLogContentCountModel();
  ...
  DataEditContent(): void {
    ...
    this.coreModuleLogContentCountService.ServiceEdit(this.dataModel).subscribe({
      next: (ret) => {
